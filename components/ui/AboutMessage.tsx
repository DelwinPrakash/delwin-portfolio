...
const AboutMessage: React.FC<AboutProps> = ({messageContent}) => {
  return (
    <section className="relative w-full max-w-4xl mx-auto my-10 p-6 text-white rounded-xl border border-zinc-700 shadow-lg hover:shadow-xl transition-shadow duration-300 backdrop-blur-xs">
