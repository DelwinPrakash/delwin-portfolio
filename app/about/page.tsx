...
export default function About(){
    return(
        <div className="inset-0 flex mt-16 sm:mt-20 z-10 text-white pointer-events-none p-2">
            <div
                className="absolute h-dvh overflow-hidden inset-0 bg-[linear-gradient(to_right,rgba(255,0,0,0.2)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,0,0,0.2)_1px,transparent_1px)] bg-[size:40px_40px] md:bg-[size:40px_40px]"
